/**
 * The 5-role club-management model (docs/12-roles-and-permissions.md,
 ...
 */
export const USER_ROLES = ["member", "coach", "reception", "branch_manager", "super_admin"] as const;
export type UserRoleName = (typeof USER_ROLES)[number];

const STAFF_ROLES: ReadonlySet<UserRoleName> = new Set(["coach", "reception"]);
...
export class Role {
   ...
   * branch_manager can grant operational roles (coach/reception/member) but
   * cannot create or demote another branch_manager or super_admin — that
