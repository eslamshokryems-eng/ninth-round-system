# @9thround/notifications — Bounded Context
...
**Planned entities/value objects:** Notification (aggregate root), PushToken, NotificationTemplate (value object, locale-aware — see docs/11-internationalization.md)

**Planned use cases:** RegisterPushToken, SendNotification (batched fan-out), MarkNotificationRead

**Planned ports (interfaces) implemented by `infrastructure/`:** NotificationRepository, PushGatewayPort (FCM-backed adapter)
